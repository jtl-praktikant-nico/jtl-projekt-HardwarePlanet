# Hardware Planet 24 – Lagerverwaltung

 Das **Backend läuft mit C# und ASP.NET Core**, das **Frontend läuft mit React und JavaScript**. Als Datenbank wird **MariaDB** genutzt.
